/**
 * Created by cailong on 2015/10/15.
 */
//modified by cailong at 151014 for requirejs(amd)


var AmCharts = (function(){
    //add by cailong for extend ownproperties
    ...
    AmCharts.AmChart = AmCharts.Class({
        construct: function () {
            ...
            if (b = this.backgroundImage)this.path && (b =
                this.path + b), this.bgImg = a = a.image(b, 0, 0, f, g), e.push(a)
        }, drawTitles: function () {
            var a = this.titles;
        ...
        initChart: function () {
            ...
            var g = AmCharts.removePx(AmCharts.getStyle(a, "padding-left")), h = AmCharts.removePx(AmCharts.getStyle(a, "padding-right")), j = AmCharts.removePx(AmCharts.getStyle(a, "padding-top")), k = AmCharts.removePx(AmCharts.getStyle(a, "padding-bottom"));
            isNaN(g) || (d -= g);
            isNaN(h) || (d -= h);
            isNaN(j) || (e -= j);
            isNaN(k) ||
            ...
            if (this.container) {
                var b = a.y, d = a.text, e = a.align, f = a.size, g = a.color, h = a.rotation, j = a.alpha, k = a.bold, l = AmCharts.toCoordinate(a.x, this.realWidth), b = AmCharts.toCoordinate(b, this.realHeight);
                l || (l = 0);
                b || (b = 0);
            ...
            a = {x: a, y: b, text: d, align: e, size: f, color: g, alpha: j, rotation: h, bold: k, url: l};
        ...
        clearLabels: function () {
            ...
            var a = this.product, b = a + ".com", d = window.location.hostname.split("."), e;
            2 <= d.length && (e = d[d.length - 2] + "." + d[d.length -
            1]);
            ...
            if (e != b) {
                ...
                for (a = 0; a < e.length; a++)e[a].attr({cursor: "pointer"})
            }
        },
                    ...
                    switch (this.mouseMode) {
                        case 1:
                            ...
                            if (!this.divIsFixed) {
                                ...
                                if (a = document.documentElement)g = a.scrollLeft, y2 = a.scrollTop;
                                f = Math.max(f, g);
                                g = Math.max(y1, y2);
                                d += f;
                                e += g
    ...
    AmCharts.getURL = function (a, b) {
        if (a)if ("_self" == b || !b)window.location.href = a; else if ("_top" == b && window.top)window.top.location.href = a; else if ("_parent" == b && window.parent)window.parent.location.href = a; else {
    ...
    AmCharts.resetDateToMin = function (a, b, d, e) {
        void 0 === e && (e = 1);
        var f = a.getFullYear(), g = a.getMonth(), h = a.getDate(), j = a.getHours(), k = a.getMinutes(), l = a.getSeconds(), m = a.getMilliseconds();
        a = a.getDay();
        switch (b) {
            case "YYYY":
                f = Math.floor(f / d) * d;
    ...
    AmCharts.formatDuration = function (a, b, d, e, f, g) {
        var h = AmCharts.intervals, j = g.decimalSeparator;
        if (a >= h[b].contains) {
    ...
    AmCharts.hitTest = function (a, b, d) {
        var e = !1, f = a.x, g = a.x + a.width, h = a.y, j = a.y + a.height, k = AmCharts.isInRectangle;
        e || (e = k(f, h, b));
        e || (e = k(f, j, b));
        e || (e = k(g, h, b));
        e || (e = k(g, j, b));
    ...
    AmCharts.formatDate = function (a, b) {
        ...
        var m = String(d).substr(2, 2), n = e + 1;
        9 > e && (n = "0" + n);
        var s = f;
        10 > f && (s = "0" + f);
        var p = "0" + g, q = h;
    ...
    AmCharts.Bezier = AmCharts.Class({
        ...
        interpolate: function (a) {
            ...
            b.push({x: a[0].x + d / f, y: a[0].y + e / g});
            var h;
            for (h = 1; h < a.length - 1; h++) {
                var j = a[h - 1], k = a[h], e = a[h + 1], d = e.x - k.x, e = e.y - j.y, j = k.x - j.x;
                j > d && (j = d);
                b.push({x: k.x - j / f, y: k.y - e / g});
                b.push({x: k.x, y: k.y});
                b.push({x: k.x + j / f, y: k.y + e / g})
            }
            e = a[a.length - 1].y - a[a.length - 2].y;
            d = a[a.length - 1].x - a[a.length - 2].x;
            b.push({x: a[a.length - 1].x - d / f, y: a[a.length - 1].y - e / g});
            b.push({
                x: a[a.length - 1].x,
                y: a[a.length - 1].y
            });
            ...
            var f = Math.round, g = this.getPointOnSegment(a, b, 0.75), h = this.getPointOnSegment(e, d, 0.75), j = (e.x - a.x) / 16, k = (e.y - a.y) / 16, l = this.getPointOnSegment(a, b, 0.375);
    ...
    AmCharts.Cuboid = AmCharts.Class({
        construct: function (a, b, d, e, f, g, h, j, k, l, m, n, s) {
            ...
            var a = this.set;
            a.clear();
            var b = this.container, d = this.w, e = this.h, f = this.dx, g = this.dy, h = this.colors, j = this.alpha, k =
                this.bwidth, l = this.bcolor, m = this.balpha, n = this.gradientRotation, s = this.cornerRadius, p = h, q = h;
            "object" == typeof h && (p = h[0], q = h[h.length - 1]);
            var r, u, t, v, x, y, w, z, C;
            if (0 < f || 0 < g)w = q, q = AmCharts.adjustLuminosity(p, -0.2), q = AmCharts.adjustLuminosity(p, -0.2), r = AmCharts.polygon(b, [0, f, d + f, d, 0], [0, g, g, 0, 0], q, j, 0, 0, 0, n), 0 < m && (C = AmCharts.line(b, [0, f, d + f], [0, g, g], l, m, k)), u = AmCharts.polygon(b, [0, 0, d, d, 0], [0, e, e, 0, 0], q, j, 0, 0, 0, 0, n), u.translate(f, g), 0 < m && (t = AmCharts.line(b, [f, f], [g, g + e], l, 1, k)), v = AmCharts.polygon(b,
                [0, 0, f, f, 0], [0, e, e + g, g, 0], q, j, 0, 0, 0, n), x = AmCharts.polygon(b, [d, d, d + f, d + f, d], [0, e, e + g, g, 0], q, j, 0, 0, 0, n), 0 < m && (y = AmCharts.line(b, [d, d + f, d + f, d], [0, g, e + g, e], l, m, k)), q = AmCharts.adjustLuminosity(w, 0.2), w = AmCharts.polygon(b, [0, f, d + f, d, 0], [e, e + g, e + g, e, e], q, j, 0, 0, 0, n), 0 < m && (z = AmCharts.line(b, [0, f, d + f], [e, e + g, e + g], l, m, k));
            1 > Math.abs(e) && (e = 0);
            1 > Math.abs(d) && (d = 0);
            b = 0 === e ? AmCharts.line(b, [0, d], [0, 0], p, m, k) : 0 === d ? AmCharts.line(b, [0, 0], [0, e], p, m, k) : 0 < s ? AmCharts.rect(b, d, e, h, j, k, l, m, s, n) : AmCharts.polygon(b, [0,
                0, d, d, 0], [0, e, e, 0, 0], h, j, k, l, m, n);
            e = 0 > e ? [r, C, u, t, v, x, y, w, z, b] : [w, z, u, t, v, x, r, C, y, b];
            for (r = 0; r < e.length; r++)(u = e[r]) && a.push(u)
        }, width: function (a) {
            this.w = a;
            this.draw()
        }, height: function (a) {
    ...
    AmCharts.AmLegend = AmCharts.Class({
        construct: function () {
            ...
            var a = this.position, b = this.marginLeft + this.titleWidth, d = this.marginRight, e = this.marginTop, f = this.marginBottom,
                g = this.horizontalGap, h = this.div, j = this.divWidth, k = this.maxColumns, l = this.verticalGap, m = this.spacing, n = j - d - b, s = 0, p = 0, q = this.container, r = q.set();
            this.set = r;
            q = q.set();
            r.push(q);
            ...
            for (v = 0; v < u.length; v++) {
                ...
                t = z.getBBox();
                var C;
                this.equalWidths ? C = g + y * (s + m + this.markerLabelGap) : (C = w, w = w + t.width + g + m);
                C + t.width > n && 0 < v && (x++, y = 0, C = g, w = C + t.width +
                g + m);
                z.translate(C, (p + l) * x);
                y++;
                !isNaN(k) && y >= k && (y = 0, x++);
            ...
            if (!1 !== a.visibleInLegend) {
                ...
                var e = AmCharts.massReplace(this.labelText, {"[[title]]": a.title}), k = this.fontSize, l = this.markerSize;
                if (g && l <= k) {
                    var m = 0;
                    if ("bubble" == d || "circle" ==
                        d)m = l / 2;
        ...
        dispatch: function (a, b) {
            ...
            if (!1 !== a.visibleInLegend) {
                ...
                if (b.valueText) {
                    ...
                    var h = b.valueText, e = e + b.lx + b.markerLabelGap + b.valueWidth, j = "end";
        ...
        createV: function () {
            ...
            h || (h = b);
            var j = this.markerBorderThickness, k = this.markerBorderAlpha;
            switch (a) {
                case "square":
                ...
                case "triangleDown":
                    ...
                    break;
                case "bubble":
                    g = AmCharts.circle(f, e / 2, b, d, j, h, k, !0), g.translate(e /
                    2, e / 2)
            }
            return g
        }, validateNow: function () {
    ...
    AmCharts.AmBalloon = AmCharts.Class({
        construct: function () {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    var h = this.l, j = this.t, k = this.r, l = this.b, m = this.textShadowColor;
                    this.color == m && (m = void 0);
                    var n = this.balloonColor, s = this.fillColor, p = this.borderColor;
                    void 0 != n && (this.adjustBorderColor ? p = n : s = n);
                    var q = this.horizontalPadding, r = this.verticalPadding, n = this.pointerWidth, u = this.pointerOrientation, t = this.cornerRadius,
                        v = e.fontFamily, x = this.fontSize;
                    void 0 == x && (x = e.fontSize);
                    e = AmCharts.text(f, this.text, this.color, v, x, d);
                    g.push(e);
                    var y;
                    void 0 != m && (y = AmCharts.text(f, this.text, m, v, x, d, !1, 0.4), g.push(y));
                    v = e.getBBox();
                    m = v.height + 2 * r;
                    v = v.width + 2 * q;
                    window.opera && (m += 2);
                    ...
                    "H" != u ? (w = a - v / 2, d = b < j + m + 10 && "down" != u ? b + n : b - m - n) : (2 * n > m && (n = m / 2), d = b - m / 2, w = a < h + (k - h) / 2 ? a + n : a - v - n);
                    d + m >= l && (d = l - m);
                    d < j &&
                    (d = j);
                    w < h && (w = h);
                    w + v > k && (w = k - v);
                    0 < t || 0 === n ? (p = AmCharts.rect(f, v, m, s, this.fillAlpha, this.borderThickness, p, this.borderAlpha, this.cornerRadius), this.showBullet && (f = AmCharts.circle(f, this.bulletSize, s, this.fillAlpha), f.translate(a, b), this.pointer = f)) : (l = [], t = [], "H" != u ? (h = a - w, h > v - n && (h = v - n), h < n && (h = n), l = [0, h - n, a - w, h + n, v, v, 0, 0], t = b < j + m + 10 && "down" != u ? [0, 0, b - d, 0, 0, m, m, 0] : [m, m, b - d, m, m, 0, 0, m]) : (j = b - d, j > m - n && (j = m - n), j < n && (j = n), t = [0, j - n, b - d, j + n, m, m, 0, 0], l = a < h + (k - h) / 2 ? [0, 0, a - w, 0, 0, v, v, 0] : [v, v, a - w, v, v, 0, 0, v]),
    ...
    AmCharts.AmCoordinateChart = AmCharts.Class({
        inherits: AmCharts.AmChart, construct: function () {
            ...
            var a =
                this.graphs, b, d = {}, e = this.seriesIdField;
            ...
            if (f) {
                ...
                var h, j;
                g && (b = AmCharts.extractPeriod(this.categoryAxis.minPeriod), h = b.period, j = b.count);
                var k = {};
                this.lookupTable = k;
                var l;
                for (l = 0; l < f.length; l++) {
                    ...
                    m.category = String(b);
                    k[n[e]] = m;
                    g && (b = isNaN(b) ? new Date(b.getFullYear(), b.getMonth(), b.getDate(), b.getHours(), b.getMinutes(), b.getSeconds(), b.getMilliseconds()) :
                        new Date(b), b = AmCharts.resetDateToMin(b, h, j), m.category = b, m.time = b.getTime());
            ...
            for (d =
                     0; d < a.length; d++)b = a[d], b.dataProvider && this.parseGraphData(b)
    ...
    AmCharts.AmRectangularChart = AmCharts.Class({
        inherits: AmCharts.AmCoordinateChart, construct: function () {
            ...
            if ("serial" == this.chartType) {
                ...
                for (b = 0; b < d.length; b++)e = d[b], e.ignoreAxisWidth || (e.setOrientation(!1), e.fixAxisPosition(), a[e.position] = !0)
            }
            ...
            for (l = 0; l < a.length; l++)b = this.getAxisBounds(a[l],
                h, k, j, b), h = b.l, k = b.r, j = b.t, b = b.b;
            ...
            var a = this.dx, b = this.dy, d = this.marginLeftReal, e = this.marginTopReal, f = this.plotAreaWidth - 1, g = this.plotAreaHeight - 1, h = this.plotAreaFillColors, j = this.plotAreaFillAlphas, k = this.plotAreaBorderColor, l = this.plotAreaBorderAlpha;
            ...
            for (b = 0; b < a.length; b++) {
                ...
                d.height =
                    this.plotAreaHeight * this.heightMultiplier;
                d.index = b;
                d.dx = this.dx;
                d.dy = this.dy;
            ...
            if (a) {
                ...
                "top" == a.position ? b ? (a.y = d, a.x = e - f) : (a.y = d - f + h, a.x =
                    e + g) : b ? (a.y = d + h, a.x = e + this.plotAreaWidth + g) : (a.y = d + this.plotAreaHeight + 1, a.x = this.marginLeftReal)
            }
        }, showZB: function (a) {
            var b = this.zbSet;
    ...
    AmCharts.TrendLine = AmCharts.Class({
        construct: function () {
            ...
            j && (k && (e = j.dateToCoordinate(k)), l && (e =
                j.categoryToCoordinate(l)), m && (f = j.dateToCoordinate(m)), n && (f = j.categoryToCoordinate(n)));
            p && !v && (isNaN(q) || (e = p.getCoordinate(q)), isNaN(r) || (f = p.getCoordinate(r)));
            s && !v && (isNaN(u) || (g = s.getCoordinate(u)), isNaN(t) || (h = s.getCoordinate(t)));
            !isNaN(e) && (!isNaN(f) && !isNaN(g) && !isNaN(g)) && (b.rotate ? (j = [g, h], f = [e, f]) : (j = [e, f], f = [g, h]), g = a.lineColor, e = AmCharts.line(d, j, f, g, a.lineAlpha, a.lineThickness, a.dashLength), f = AmCharts.line(d, j, f, g, 0.005, 5), d = d.set([e, f]), d.translate(b.marginLeftReal, b.marginTopReal),
    ...
    AmCharts.AmSerialChart = AmCharts.Class({
        ...
        drawChart: function () {
            ...
            if (0 < e && b - a < e) {
                var f = Math.round(a + (b - a) / 2), e = Math.round(e / 2);
                a = f - e;
                b = f + e
            }
            var g = this.chartData, f = this.categoryAxis;
            if (AmCharts.ifArray(g) && (a != this.startTime || b != this.endTime)) {
                var h = f.minDuration(), e = this.firstTime, j = this.lastTime;
                a || (a = e, isNaN(d) || (a = j - d));
                b || (b = j);
                a > j && (a = j);
                b < e && (b = e);
            ...
            for (j = 0; j < b; j++) {
                ...
                if ("none" ==
                    k || "3d" == k)for (h = 0; h < d; h++)e = this.graphs[h], !e.hidden && (e.valueAxis == f && "column" == e.type) && (e.columnIndex = a, a++);
                if ("3d" == k) {
            ...
            var h = f + Math.round((g - f) / 2), j = a[h][b];
            if (1 >= g - f) {
                if (e)return f;
                e = a[g][b];
            ...
            e = b.graph.valueAxis;
            if ((f = e.duration) && !isNaN(b.values.value))e = AmCharts.formatDuration(b.values.value, f,
                "", e.durationUnits, e.maxInterval, d), a = a.replace(RegExp("\\[\\[value\\]\\]", "g"), e);
    ...
    AmCharts.AxisBase = AmCharts.Class({
        construct: function () {
            ...
            isNaN(this.titleFontSize) && (this.titleFontSize =
                a.fontSize + 1);
            this.allLabels = [];
            this.counter = 0;
            this.destroy();
            ...
            if (a) {
                ...
                var h = f.width, f = f.height, j = this.viW, k = this.viH;
                a.getBBox();
                var l = 0, m = this.titleFontSize / 2, n = this.inside;
        ...
        draw: function () {
            ...
            if (this.logarithmic && (0 >= this.getMin(0, this.data.length - 1) || 0 >= this.minimum))this.fire("logarithmicAxisFailed", {
                ...
                if (!isNaN(this.min) && !isNaN(this.max) && this.foundGraphs && Infinity != this.min && -Infinity !=
                    ...
                    !0 === j ? (r = Math.log(this.max) * Math.LOG10E - Math.log(this.minReal) * Math.LOG10E, this.stepWidth = this.axisWidth / r, 2 < r && (q = Math.ceil(Math.log(this.max) * Math.LOG10E) + 1, p = Math.round(Math.log(this.minReal) * Math.LOG10E), q > this.gridCount && (s = Math.ceil(q / this.gridCount)))) : this.stepWidth = this.axisWidth / (this.max - this.min);
                    d = 0;
                    ...
                    if (0 < x) {
                        ...
                        for (e = this.fillAlpha = 0; e < x; e++) {
                            var w = v[e], z = NaN, C = w.above;
                            isNaN(w.toValue) ||
                            (z = this.getCoordinate(w.toValue), t = new this.axisItemRenderer(this, z, "", !0, NaN, NaN, w), this.pushAxisItem(t, C));
                            var I = NaN;
                            isNaN(w.value) || (I = this.getCoordinate(w.value), t = new this.axisItemRenderer(this, I, w.label, !0, NaN, (z - I) / 2, w), this.pushAxisItem(t, C));
                            isNaN(z - I) || (t = new this.guideFillRenderer(this, I, z, w), this.pushAxisItem(t, C), t = t.graphics(), w.graphics = t, w.balloonText && this.addEventListeners(t, w))
                        }
                        this.fillAlpha = y
                    }
                    v = !1;
                    for (e = p; e < q; e += s)t = AmCharts.roundTo(this.step * e + this.min, d), -1 != String(t).indexOf("e") &&
                    ...
                    for (e = p; e < q; e += s)if (p = this.step * e + this.min, p = AmCharts.roundTo(p, this.maxDecCount + 1), !(this.integersOnly && Math.round(p) != p)) {
                        !0 === j && (0 === p && (p = this.minReal), 2 < r && (p = Math.pow(10, e)), v = -1 != String(p).indexOf("e") ? !0 : !1);
                        this.useScientificNotation && (v = !0);
                        this.usePrefixes && (v = !1);
                        v ? (t = -1 == String(p).indexOf("e") ? p.toExponential(15) : String(p), t = t.split("e"), d = Number(t[0]), t = Number(t[1]), d = AmCharts.roundTo(d,
                            14), 10 == d && (d = 1, t += 1), t = d + "e" + t, 0 === p && (t = "0"), 1 == p && (t = "1")) : (j && (d = String(p).split("."), u.precision = d[1] ? d[1].length : -1), t = this.usePrefixes ? AmCharts.addPrefix(p, a.prefixesOfBigNumbers, a.prefixesOfSmallNumbers, u) : AmCharts.formatNumber(p, u, u.precision));
                        ...
                        if (p == this.baseValue && "radar" != k) {
                            ...
                            t = this.viY;
                            "H" == this.orientation ? 0 <= d && d <= x + 1 && (G = [d, d, d + f], T = [y, 0, g]) : 0 <= d && d <= y + 1 && (G = [0, x, x + f], T = [d, d, d + g]);
                            G && (d = AmCharts.fitToBounds(2 * this.gridAlpha, 0, 1), d = AmCharts.line(a.container, G, T, this.gridColor, d, 1, this.dashLength), d.translate(p, t), this.grid0 = d, a.axesSet.push(d), d.toBack())
                        }
                    }
                    e = this.baseValue;
                    this.min > this.baseValue && this.max >
                    this.baseValue && (e = this.min);
                ...
                !this.visible || h ? (b.hide(), j.hide(), a.hide()) : (b.show(),
                    j.show(), a.show())
            }
            ...
            if (p && ("regular" == b || "100%" == b))for (n = 0; n < j.length; n++)m =
                j[n], m.hidden || (l = m.type, m.chart == this.chart && (m.valueAxis == this && a == l && m.stackable) && (k && (m.stackGraph = k), k = m));
            for (k = this.start; k <= this.end; k++) {
                ...
                for (n = 0; n < j.length; n++)if (m = j[n], !m.hidden && (l = m.type, m.chart == this.chart && (m.valueAxis == this && a == l && m.stackable) && (l = this.data[k].axes[this.id].graphs[m.id], h = l.values.value, !isNaN(h)))) {
                    ...
                    m = m.fillToGraph;
                    if (p && m && (m = this.data[k].axes[this.id].graphs[m.id]))l.values.open =
                        m.values.value;
            ...
            for (k = this.start; k <= this.end; k++)for (n = 0; n < j.length; n++)m =
            ...
            if (this.includeGuidesInMinMax &&
                0 < a)for (b = 0; b < a; b++)d = this.guides[b], d.toValue < this.min && (this.min = d.toValue), d.value < this.min && (this.min = d.value), d.toValue > this.max && (this.max = d.toValue), d.value > this.max && (this.max = d.value);
            ...
            "100%" == this.stackType && (this.min = 0 > this.min ?
                -100 : 0, this.max = 0 > this.max ? 0 : 100);
            d = this.max - this.min;
            ...
            1 > d ? (this.maxDecCount = Math.abs(Math.log(Math.abs(d)) * Math.LOG10E), this.maxDecCount =
                Math.round(this.maxDecCount), this.step = AmCharts.roundTo(this.step, this.maxDecCount + 1)) : this.maxDecCount = 0;
            ...
            0 < this.min &&
            0 < this.minReal - this.step && (this.minReal = this.min + this.step < this.minReal ? this.min + this.step : this.min);
            ...
            for (e = a; e <= b; e++) {
                ...
                for (g in f)if (f.hasOwnProperty(g)) {
                    ...
                    if (h.includeInMinMax && (!h.hidden || this.includeHidden)) {
                        ...
                        var j;
                        if (this.minMaxField)j = h[this.minMaxField], j < d && (d =
                            j); else for (var k in h)h.hasOwnProperty(k) && ("percents" != k && "total" != k) && (j = h[k], j < d && (d = j))
                    }
                }
            }
            return d
            ...
            for (b = this.start; b <= this.end; b++) {
                ...
                for (e in d)if (d.hasOwnProperty(e)) {
                    ...
                    if (f.includeInMinMax && (!f.hidden || this.includeHidden)) {
                        ...
                        var g;
                        if (this.minMaxField)g = f[this.minMaxField], g > a && (a = g); else for (var h in f)f.hasOwnProperty(h) &&
                        ("percents" != h && "total" != h) && (g = f[h], g > a && (a = g))
                    }
                }
            }
            return a
            ...
            d.position = "V" == this.orientation ? this.reversed ? this.getCoordinate(a) -
            this.y : this.getCoordinate(b) - this.y : this.reversed ? this.getCoordinate(b) - this.x : this.getCoordinate(a) - this.x;
            this.fire(d.type, d)
            ...
            if (isNaN(a))return NaN;
            var b = this.rotate, d = this.reversed,
                e = this.axisWidth, f = this.stepWidth, g = this.min, h = this.minReal;
    ...
    AmCharts.CategoryAxis = AmCharts.Class({
        inherits: AmCharts.AxisBase, construct: function () {
            ...
            this.periods = [{period: "ss", count: 1}, {period: "ss", count: 5}, {period: "ss", count: 10}, {
                period: "ss",
                count: 30
            }, {period: "mm", count: 1}, {period: "mm", count: 5}, {period: "mm", count: 10}, {period: "mm", count: 30},
                {period: "hh", count: 1}, {period: "hh", count: 3}, {period: "hh", count: 6}, {
                    period: "hh",
                    count: 12
                }, {period: "DD", count: 1}, {period: "DD", count: 2}, {period: "WW", count: 1}, {
                    period: "MM",
                    count: 1
            ...
            this.data = a;
            if (AmCharts.ifArray(a)) {
                var b, d = this.chart, e = this.start, f = this.labelFrequency,
                    g = 0;
                b = this.end - e + 1;
                ...
                if (this.parseDates && !this.equalSpacing) {
                    if (this.timeDifference = this.endTime - this.startTime, e = this.choosePeriod(0), f =
                        ...
                        v = !1;
                        r ? (m = this.dateFormatsObject[this.nextPeriod[a]], v = !0) : m = this.dateFormatsObject[a];
                        t || (v = !1);
                    ...
                    if (this.parseDates && this.equalSpacing) {
                        ...
                        u = !1;
                        for (this.end - this.start > this.gridCount && (u = !0); b < p; b++)if (q = this.data[b].time, this.checkPeriodChange(f, n, q, m)) {
                    ...
                    for (h = 0; b <= this.end + 2; b += t) {
                        ...
                        u = this.cellWidth;
                        n && (u = NaN);
                        l = new this.axisItemRenderer(this, l, m, !0, u, p,
                            void 0, !1, p);
                        this.pushAxisItem(l)
                    }
                }
                for (b = 0; b < this.data.length; b++)if (j = this.data[b])k = this.parseDates && !this.equalSpacing ? Math.round((j.time - this.startTime) * this.stepWidth + this.cellWidth / 2) : this.getCoordinate(b - g), j.x[this.id] = k;
                j = this.guides.length;
                for (b = 0; b < j; b++)k = this.guides[b], p = p = p = h = t = NaN, e = k.above, k.toCategory && (p = d.getCategoryIndexByValue(k.toCategory), isNaN(p) || (t = this.getCoordinate(p - g), l = new this.axisItemRenderer(this, t, "", !0, NaN, NaN, k), this.pushAxisItem(l, e))), k.category && (p = d.getCategoryIndexByValue(k.category),
    ...
    AmCharts.RecAxis = AmCharts.Class({
        construct: function (a) {
            var b = a.chart, d = a.axisThickness, e = a.axisColor, f = a.axisAlpha, g = a.offset, h = a.dx, j = a.dy, k = a.viX, l = a.viY, m = a.viH, n = a.viW, s = b.container;
    ...
    AmCharts.RecItem = AmCharts.Class({
        construct: function (a, b, d, e, f, g, h, j, k) {
            ...
            this.set = p;
            var q = a.axisThickness, r = a.axisColor, u = a.axisAlpha, t = a.tickLength, v = a.gridAlpha, x = a.gridThickness, y = a.gridColor, w = a.dashLength, z = a.fillColor, C = a.fillAlpha, I = a.labelsEnabled, G = a.labelRotation, T = a.counter, Q = a.inside,
                U = a.dx, S = a.dy, ea = a.orientation, N = a.position, V = a.previousCoord, fa = a.viH, ca = a.viW, da = a.offset, ma, W;
            h ? (I = !0, isNaN(h.tickLength) || (t = h.tickLength), void 0 != h.lineColor && (y = h.lineColor), isNaN(h.lineAlpha) || (v = h.lineAlpha), isNaN(h.dashLength) || (w = h.dashLength), isNaN(h.lineThickness) || (x = h.lineThickness), !0 === h.inside && (Q = !0), isNaN(h.labelRotation) || (G = h.labelRotation)) : "" === d && (t = 0);
            W = "start";
            f && (W = "middle");
            var O = G * Math.PI / 180, aa, F = 0, E = 0, A = 0, ga = aa = 0;
            "V" == ea && (G = 0);
            var X;
            I && (X = AmCharts.text(s, d, n, l, m, W,
            ...
            if ("H" == ea) {
                if (0 <= b && b <= ca + 1 && (0 < t && (0 < u && b + k <= ca + 1) && (ma = AmCharts.line(s, [b + k, b + k], [0, t], r, u, x), p.push(ma)), 0 < v && (W = AmCharts.line(s, [b, b + U, b + U], [fa, fa + S, S], y, v, x, w), p.push(W))), E = 0, F = b, h && 90 == G && (F -= m), !1 === e ? (W = "start", E = "bottom" == N ? Q ? E + t : E - t : Q ? E - t : E + t, F += 3, f && (F += f / 2, W = "middle"), 0 < G && (W = "middle")) : W = "middle", 1 == T && (0 < C && !h && V < ca) && (e = AmCharts.fitToBounds(b, 0, ca), V = AmCharts.fitToBounds(V, 0, ca), aa = e - V, 0 < aa && (fill = AmCharts.rect(s, aa, a.height, z, C), fill.translate(e - aa + U, S),
                        p.push(fill))), "bottom" == N ? (E += fa + m / 2 + da, Q ? 0 < G ? (E = fa - ga / 2 * Math.sin(O) - t - 3, F += ga / 2 * Math.cos(O)) : E -= t + m + 3 + 3 : 0 < G ? (E = fa + ga / 2 * Math.sin(O) + t + 3, F -= ga / 2 * Math.cos(O)) : E += t + q + 3 + 3) : (E += S + m / 2 - da, F += U, Q ? 0 < G ? (E = ga / 2 * Math.sin(O) + t + 3, F -= ga / 2 * Math.cos(O)) : E += t + 3 : 0 < G ? (E = -(ga / 2) * Math.sin(O) - t - 6, F += ga / 2 * Math.cos(O)) : E -= t + m + 3 + q + 3), "bottom" == N ? aa = (Q ? fa - t - 1 : fa + q - 1) + da : (A = U, aa = (Q ? S : S - t - q + 1) - da), g && (F += g), S = F, 0 < G && (S += ga / 2 * Math.cos(O)), X && (N = 0, Q && (N = ga / 2 * Math.cos(O)), S + N > ca + 1 || 0 > S))X.remove(), X = null
            } else {
                0 <= b && b <= fa + 1 && (0 <
                t && (0 < u && b + k <= fa + 1) && (ma = AmCharts.line(s, [0, t], [b + k, b + k], r, u, x), p.push(ma)), 0 < v && (W = AmCharts.line(s, [0, U, ca + U], [b, b + S, b + S], y, v, x, w), p.push(W)));
                W = "end";
                if (!0 === Q && "left" == N || !1 === Q && "right" == N)W = "start";
                E = b - m / 2;
                1 == T && (0 < C && !h) && (e = AmCharts.fitToBounds(b, 0, fa), V = AmCharts.fitToBounds(V, 0, fa), O = e - V, fill = AmCharts.polygon(s, [0, a.width, a.width, 0], [0, 0, O, O], z, C), fill.translate(U, e - O + S), p.push(fill));
                E += m / 2;
                "right" == N ? (F += U + ca + da, E += S, Q ? (F -= t + 4, g || (E -= m / 2 + 3)) : (F += t + 4 + q, E -= 2)) : Q ? (F += t + 4 - da, g || (E -= m / 2 + 3), h &&
                (F += U, E += S)) : (F += -t - q - 4 - 2 - da, E -= 2);
                ma && ("right" == N ? (A += U + da + ca, aa += S, A = Q ? A - q : A + q) : (A -= da, Q || (A -= t + q)));
                g && (E += g);
                Q = -3;
                "right" == N && (Q += S);
                if (X && (E > fa + 1 || E < Q))X.remove(), X = null
            }
            ma && ma.translate(A, aa);
            !1 === a.visible && (ma && ma.remove(), X && (X.remove(), X = null));
            X && (X.attr({"text-anchor": W}), X.translate(F, E), 0 !== G && X.rotate(-G), a.allLabels.push(X), " " != d && (this.label = X));
            a.counter = 0 === T ? 1 : 0;
            a.previousCoord = b;
    ...
    AmCharts.RecFill = AmCharts.Class({
        construct: function (a, b, d, e) {
            var f = a.dx, g = a.dy, h = a.orientation, j = 0;
            if (d < b) {
                var k = b;
                b = d;
                d = k
            ...
            "V" == h ? (a = AmCharts.rect(k, a.width, d, e, l), a.translate(f, b - j + g)) : (a = AmCharts.rect(k,
                d, a.height, e, l), a.translate(b - j + f, g));
            this.set = k.set([a])
        }, graphics: function () {
            return this.set
        }, getLabel: function () {
    ...
    AmCharts.RadAxis = AmCharts.Class({
        construct: function (a) {
            ...
            var j = a.axisTitleOffset, k = a.radarCategoriesEnabled, l = a.chart.fontFamily, m = a.fontSize;
            void 0 === m && (m = a.chart.fontSize);
            var n = a.color;
            void 0 === n && (n = a.chart.color);
            if (b) {
                ...
                var s = a.length, p;
                for (p = 0; p < s; p++) {
                    var q = 180 - 360 / s * p, r = g + this.axisWidth * Math.sin(q / 180 * Math.PI), u = h + this.axisWidth * Math.cos(q /
                        180 * Math.PI);
                    0 < f && (r = AmCharts.line(b.container, [g, r], [h, u], e, f, d), this.set.push(r));
                    if (k) {
                        var t = "start", r = g + (this.axisWidth + j) * Math.sin(q / 180 * Math.PI), u = h + (this.axisWidth + j) * Math.cos(q / 180 * Math.PI);
    ...
    AmCharts.RadItem = AmCharts.Class({
        construct: function (a, b, d, e, f, g, h) {
            void 0 === d && (d = "");
            var j = a.chart.fontFamily, k = a.fontSize;
            void 0 === k && (k = a.chart.fontSize);
            var l = a.color;
            void 0 === l && (l = a.chart.color);
            var m = a.chart.container;
            this.set = e = m.set();
            var n = a.axisColor, s = a.axisAlpha, p = a.tickLength, q = a.gridAlpha, r = a.gridThickness, u = a.gridColor, t = a.dashLength, v = a.fillColor, x = a.fillAlpha, y = a.labelsEnabled;
            f = a.counter;
            ...
            g = a.x;
            var G = a.y;
            h ? (y = !0, isNaN(h.tickLength) ||
            (p = h.tickLength), void 0 != h.lineColor && (u = h.lineColor), isNaN(h.lineAlpha) || (q = h.lineAlpha), isNaN(h.dashLength) || (t = h.dashLength), isNaN(h.lineThickness) || (r = h.lineThickness), !0 === h.inside && (w = !0)) : d || (q /= 3, p /= 2);
            var T = "end", Q = -1;
            w && (T = "start", Q = 1);
            var U;
            y && (U = AmCharts.text(m, d, l, j, k, T), U.translate(g + (p + 3) * Q, b), e.push(U), this.label = U, I = AmCharts.line(m, [g, g + p * Q], [b, b], n, s, r), e.push(I));
            b = a.y - b;
            d = [];
            j = [];
            if (0 < q) {
                if ("polygons" == z) {
                    C = a.data.length;
                    for (k = 0; k < C; k++)l = 180 - 360 / C * k, d.push(b * Math.sin(l / 180 * Math.PI)),
                        j.push(b * Math.cos(l / 180 * Math.PI));
                    d.push(d[0]);
                    j.push(j[0]);
                    q = AmCharts.line(m, d, j, u, q, r, t)
                } else q = AmCharts.circle(m, b, "#FFFFFF", 0, r, u, q);
                q.translate(g, G);
                e.push(q)
            }
            if (1 == f && 0 < x && !h) {
                h = a.previousCoord;
                if ("polygons" == z) {
                    for (k = C; 0 <= k; k--)l = 180 - 360 / C * k, d.push(h * Math.sin(l / 180 * Math.PI)), j.push(h * Math.cos(l / 180 * Math.PI));
    ...
    AmCharts.RadarFill = AmCharts.Class({
        construct: function (a, b, d, e) {
            ...
            b = d = Math.min(b, d);
            d = a.chart.container;
            var g = e.fillAlpha, h = e.fillColor, f = Math.abs(f - a.y);
            b = Math.abs(b - a.y);
            var j = Math.max(f, b);
            b = Math.min(f, b);
            f = j;
            ...
            if ("polygons" == a.gridType) {
                ...
                for (m = 0; m < l; m++)j = 180 - 360 / l * m, e.push(f * Math.sin(j / 180 * Math.PI)), k.push(f *
                Math.cos(j / 180 * Math.PI));
                e.push(e[0]);
                k.push(k[0]);
    ...
    AmCharts.AmGraph = AmCharts.Class({
        construct: function () {
            ...
            this.allBullets = [];
            this.animationArray = [];
            AmCharts.ifArray(this.data) && (d = !1, "xy" == this.chartType ?
            this.xAxis.axisCreated && this.yAxis.axisCreated && (d = !0) : this.valueAxis.axisCreated && (d = !0), !this.hidden && d && this.createGraph())
            ...
            void 0 === this.bulletColor && (this.bulletColor = this.lineColor, this.bulletColorNegative =
            ...
            for (f = this.start; f <= this.end; f++) {
                var g = this.data[f].axes[d.id].graphs[this.id], h = g.values, j = h.x, k = h.y, h = d.getCoordinate(j), l = e.getCoordinate(k);
                if (!isNaN(j) && !isNaN(k) && (a.push(h), b.push(l), (j = this.createBullet(g, h, l, f)) || (j = 0), k = this.labelText))g = this.createLabel(g, h, l, k), this.allBullets.push(g), this.positionLabel(h, l, g, this.labelPosition, j)
            }
            ...
            for (g = this.start; g <= this.end; g++) {
                var h =
                    this.data[g].axes[this.valueAxis.id].graphs[this.id], j;
                j = "none" == a || "3d" == a ? h.values.value : h.values.close;
                if (isNaN(j))this.drawLineGraph(b, d), b = [], d = []; else {
                    var k = this.y - (this.valueAxis.getCoordinate(j) - this.height), l = 180 - 360 / (this.end - this.start + 1) * g;
            ...
            var a = this.id, b = this.index, d = this.data, e = this.chart.container, f = this.valueAxis, g = this.type, h = this.columnWidth, j = this.width, k = this.height, l = this.y, m = this.rotate,
            ...
            var O = this.chart.columnSpacing, aa = Q.cellWidth, F = (aa * h - n) / n;
            O > F && (O = F);
            ...
            if (!T && ("line" == g || "smoothedLine" == g || "step" ==
                g))if (1 == d.length && ("step" != g && "none" == this.bullet) && (this.bullet = "round", this.resetBullet = !0), Fa || void 0 != ya) {
                var Aa = S;
                Aa > f.max && (Aa = f.max);
                Aa < f.min && (Aa = f.min);
                f.logarithmic && (Aa = f.minReal);
                var ta = f.getCoordinate(Aa), nb = f.getCoordinate(f.max);
            ...
            for (L = I; L <= G; L++) {
                ...
                if (sa) {
                    ...
                    if ("candlestick" == g || "ohlc" == g)R = sa.close, Ua = sa.low, Ba = f.getCoordinate(Ua),
                        Ta = sa.high, Ca = f.getCoordinate(Ta);
                    ja = sa.open;
                    B = f.getCoordinate(R);
                    ...
                    var oa = E.x[Q.id], wa = Math.floor(aa / 2), Ka = wa;
                    "start" == this.pointPosition && (oa -= aa / 2, wa = 0, Ka = aa);
                    T || (A.x = oa);
                    -1E5 > oa && (oa = -1E5);
                    oa > j + 1E5 && (oa = j + 1E5);
                    m ? (D = B, P = M, M = B = oa, isNaN(ja) && !this.fillToGraph && (P = U), Ra = Ba, Sa = Ca) : (P = D = oa, isNaN(ja) && !this.fillToGraph && (M = U));
                    switch (g) {
                        case "line":
                            isNaN(R) ?
                            p || (this.drawLineGraph(q, r, ha, ia), q = [], r = [], ha = [], ia = []) : (A.isNegative = R < S ? !0 : !1, q.push(D), r.push(B), Y = D, ba = B, pa = D, qa = B, Ia && (!isNaN(M) && !isNaN(P)) && (ha.push(P), ia.push(M)));
                            break;
                        case "smoothedLine":
                            isNaN(R) ? p || (this.drawSmoothedGraph(q, r, ha, ia), q = [], r = [], ha = [], ia = []) : (A.isNegative = R < S ? !0 : !1, q.push(D), r.push(B), Y = D, ba = B, pa = D, qa = B, Ia && (!isNaN(M) && !isNaN(P)) && (ha.push(P), ia.push(M)));
                            break;
                        case "step":
                            isNaN(R) ? p || (t = NaN, this.drawLineGraph(q, r, ha, ia), q = [], r = [], ha = [], ia = []) : (A.isNegative = R < S ? !0 : !1, m ?
                                (isNaN(u) || (q.push(u), r.push(B - wa)), r.push(B - wa), q.push(D), r.push(B + Ka), q.push(D), Ia && (!isNaN(M) && !isNaN(P)) && (ha.push(P), ia.push(M - wa), ha.push(P), ia.push(M + Ka))) : (isNaN(t) || (r.push(t), q.push(D - wa)), q.push(D - wa), r.push(B), q.push(D + Ka), r.push(B), Ia && (!isNaN(M) && !isNaN(P)) && (ha.push(P - wa), ia.push(M), ha.push(P + Ka), ia.push(M))), u = D, t = B, Y = D, ba = B, pa = D, qa = B);
                            break;
                        case "column":
                            la = na;
                            void 0 != A.lineColor && (la = A.lineColor);
                            if (!isNaN(R)) {
                                R < S ? (A.isNegative = !0, Fa && (va = Fa), void 0 != ya && (na = ya)) : A.isNegative = !1;
                                var ob = f.min, pb = f.max;
                                if (!(R < ob && ja < ob || R > pb && ja > pb))if (m) {
                                    "3d" == z ? (K = B - 0.5 * (h + O) + O / 2 + w * ea, J = P + y * ea) : (K = B - (n / 2 - ea) * (h + O) + O / 2, J = P);
                                    H = h;
                                    Y = D;
                                    ba = K + h / 2;
                                    pa = D;
                                    ...
                                    if (K < k && 0 < H && (ka = new AmCharts.Cuboid(e, Z, H, y, w, va, Ja, N, la, V, W, s, m), "bottom" != C))if (C = f.reversed ? "left" : "right", 0 > R)C = f.reversed ? "right" : "left"; else if ("regular" == z || "100%" == z)Y += this.dx
                                } else {
                                    "3d" == z ? (J = D - 0.5 * (h + O) + O / 2 +
                                    y * ea, K = M + w * ea) : (J = D - (n / 2 - ea) * (h + O) + O / 2, K = M);
                                    H = h;
                                    Y = J + h / 2;
                                    ba = B;
                                    pa = J + h / 2;
                                    ...
                                    if (J < j + ea * y && 0 < H)if (ka = new AmCharts.Cuboid(e, H, Z, y, w, va, Ja, N, la, this.lineAlpha, W, s, m), 0 > R && "middle" != C)C = "bottom"; else if (C = ma, "regular" == z || "100%" == z)ba += this.dy
                                }
                                if (ka && (ra = ka.set, ra.translate(J, K), this.columnsSet.push(ra), A.url && ra.setAttr("cursor", "pointer"), !T)) {
                                    "none" == z && (x = m ? (this.end +
                                    1 - L) * v - b : v * L + b);
                                    "3d" == z && (m ? (x = (v - b) * (this.end + 1 - L), Y += y * this.columnIndex, pa += y * this.columnIndex, A.y += y * this.columnIndex) : (x = (v - b) * (L + 1), Y += 3, ba += w * this.columnIndex + 7, qa += w * this.columnIndex, A.y += w * this.columnIndex));
                                    if ("regular" == z || "100%" == z)C = "middle", x = m ? 0 < sa.value ? (this.end + 1 - L) * v + b : (this.end + 1 - L) * v - b : 0 < sa.value ? v * L + b : v * L - b;
                                    this.columnsArray.push({column: ka, depth: x});
                                    A.x = m ? K + H / 2 : J + H / 2;
                        ...
                        case "candlestick":
                            if (!isNaN(ja) && !isNaN(Ta) && !isNaN(Ua) && !isNaN(R)) {
                                var Va, bb;
                                R < ja && (A.isNegative = !0, Fa && (va = Fa), Ha && (Ja = Ha), void 0 != ya && (na = ya));
                                la = na;
                                void 0 != A.lineColor && (la = A.lineColor);
                                if (m) {
                                    if (K = B - h / 2, J = P, H = h, K + H > k && (H = k - K), 0 > K && (H += K, K = 0), K < k && 0 < H) {
                                        var cb, db;
                                        R > ja ? (cb = [D, Sa], db = [P, Ra]) : (cb = [P, Sa], db = [D, Ra]);
                                    ...
                                    var ka =
                                        new AmCharts.Cuboid(e, H, Z, y, w, va, Ja, N, la, V, W, s, m), eb, fb;
                                    R > ja ? (eb = [B, Ca], fb = [M, Ba]) : (eb = [M, Ca], fb = [B, Ba]);
                                    D < j && 0 < D && (Va = AmCharts.line(e, [D, D], eb, la, V, N), bb = AmCharts.line(e, [D, D], fb, la, V, N))
                                }
                                ka && (ra = ka.set, da.push(ra), ra.translate(J, K), A.url && ra.setAttr("cursor", "pointer"), Va && (da.push(Va), da.push(bb)), Y = D, ba = B, pa = D, qa = B, T || (A.x = m ? K + H / 2 : J + H / 2, this.animateColumns(ka, L, D, P, B, M), this.addListeners(ra, A)))
                            }
                            break;
                        case "ohlc":
                            if (!isNaN(ja) && !isNaN(Ta) && !isNaN(Ua) && !isNaN(R)) {
                                R < ja && (A.isNegative = !0, void 0 !=
                                ya && (na = ya));
                                var gb, hb, ib;
                                if (m) {
                                    var jb = B - h / 2, jb = AmCharts.fitToBounds(jb, 0, k), qb = AmCharts.fitToBounds(B, 0, k), kb = B + h / 2, kb = AmCharts.fitToBounds(kb, 0, k);
                                    ...
                                    var lb = D - h / 2, lb = AmCharts.fitToBounds(lb, 0, j), rb = AmCharts.fitToBounds(D, 0, j), mb = D + h / 2, mb = AmCharts.fitToBounds(mb, 0, j);
                                    hb = AmCharts.line(e, [lb, rb], [M, M], na, V, N, ca);
                                    0 < D && D < j && (gb = AmCharts.line(e, [D, D], [Ba, Ca],
                                        na, V, N, ca));
                    ...
                    if (!T && !isNaN(R)) {
                        ...
                        if (this.end - this.start <= sb || 0 === sb) {
                            ...
                            if (tb) {
                                var $ = this.createLabel(A, 0, 0, tb), xa = 0, za = 0, ub = $.getBBox(), Wa = ub.width, Xa = ub.height;
                                switch (C) {
                                    case "left":
                                        xa = -(Wa / 2 + Da / 2 + 3);
                                        break;
                                    ...
                                    case "bottom":
                                        m && "column" == g ? (Y =
                                            U, 0 > R ? (xa = -6, $.attr({"text-anchor": "end"})) : (xa = 6, $.attr({"text-anchor": "start"}))) : (za = Da / 2 + Xa / 2, $.x = -(Wa / 2 + 2));
                                        break;
                                    case "middle":
                                        "column" == g && (m ? (za = -(Xa / 2) + this.fontSize / 2, xa = -(D - P) / 2 - y, 0 > Z && (xa += y), Math.abs(D - P) < Wa && !this.showAllValueLabels && ($.remove(), $ = null)) : (za = -(B - M) / 2, 0 > Z && (za -= w), Math.abs(B - M) < Xa && !this.showAllValueLabels && ($.remove(), $ = null)))
                                }
                                if ($) {
                                    if (!isNaN(ba) && !isNaN(Y))if (Y += xa, ba += za, $.translate(Y, ba), m) {
                                        if (0 > ba || ba > k)$.remove(), $ = null
                                    } else {
                                        var vb = 0;
                                        "3d" == z && (vb = y * ea);
                                        if (0 > Y ||
                            ...
                            if ("column" == g && "regular" == z || "100%" == z) {
                                ...
                                if (wb) {
                                    ...
                                    Ab && Ab.remove();
                                    m ? (Ma = B, La = 0 > R ? D - yb / 2 - 2 : D + yb / 2 + 3) : (La = D, Ma = 0 > R ? B + zb / 2 : B - zb / 2 - 3);
                                    Ea.translate(La, Ma);
                                    f.totals[L] = Ea;
            ...
            if ("line" == g || "step" == g || "smoothedLine" == g)"smoothedLine" ==
            g ? this.drawSmoothedGraph(q, r, ha, ia) : this.drawLineGraph(q, r, ha, ia), T || this.launchAnimation()
            ...
            if (1 < a.length) {
                var f = this.set, g = this.container, h = g.set(), j = g.set();
                f.push(h);
                f.push(j);
                var k = this.lineAlpha, l = this.lineThickness, m = this.dashLength, f = this.fillAlphas, n = this.fillColors,
                    s = this.negativeLineColor, p = this.negativeFillColors, q = this.negativeFillAlphas, r = this.baseCoord, u = AmCharts.line(g, a, b, this.lineColor, k, l, m, !1, !0);
                h.push(u);
                void 0 !== s && (k = AmCharts.line(g, a, b, s, k, l, m, !1, !0), j.push(k));
                if (0 < f && (k = a.join(";").split(";"), l = b.join(";").split(";"), "serial" == this.chartType && (0 < d.length ? (d.reverse(), e.reverse(), k = a.concat(d), l = b.concat(e)) : this.rotate ? (l.push(l[l.length - 1]), k.push(r), l.push(l[0]), k.push(r), l.push(l[0]), k.push(k[0])) : (k.push(k[k.length - 1]), l.push(r), k.push(k[0]),
                        l.push(r), k.push(a[0]), l.push(l[0]))), a = AmCharts.polygon(g, k, l, n, f, 0, 0, 0, this.gradientRotation), h.push(a), p || void 0 !== s))isNaN(q) && (q = f), p || (p = s), g = AmCharts.polygon(g, k, l, p, q, 0, 0, 0, this.gradientRotation), j.push(g);
                this.applyMask(j, h)
            }
            ...
            if (1 < a.length) {
                ...
                var k = this.lineAlpha,
                    l = this.lineThickness, f = this.dashLength, m = this.fillAlphas, n = this.fillColors, s = this.negativeLineColor, p = this.negativeFillColors, q = this.negativeFillAlphas, r = this.baseCoord, u = new AmCharts.Bezier(g, a, b, this.lineColor, k, l, n, 0, f);
                h.push(u.path);
                void 0 !== s && (k = new AmCharts.Bezier(g, a, b, s, k, l, n, 0, f), j.push(k.path));
                if (0 < m && (l = a.join(";").split(";"), u = b.join(";").split(";"), k = "", 0 < d.length ? (d.reverse(), e.reverse(), l = a.concat(d), u = b.concat(e)) : (this.rotate ? (k += " L" + r + "," + b[b.length - 1], k += " L" + r + "," + b[0]) : (k +=
                        " L" + a[a.length - 1] + "," + r, k += " L" + a[0] + "," + r), k += " L" + a[0] + "," + b[0]), d = new AmCharts.Bezier(g, l, u, NaN, 0, 0, n, m, f, k), h.push(d.path), p || void 0 !== s))q || (q = m), p || (p = s), a = new AmCharts.Bezier(g, a, b, NaN, 0, 0, p, q, f, k), j.push(a.path);
                this.applyMask(j, h)
            }
            ...
            b && (this.rotate ? (b.translate(-1E3, f), d.translate(-1E3, f)) : (b.translate(e, -1E3), d.translate(e, -1E3)), b.animate({
                opacity: 1,
                translate: e + "," + f
            }, g, a), d.animate({opacity: 1, translate: e + "," + f}, g, a))
        }, animate: function (a) {
            ...
            var e =
                this.container, f = this.bulletOffset, g = this.bulletSize;
            ...
            if ("none" != this.bullet || a.bullet) {
                ...
                f = this.bullet;
                a.bullet && (f = a.bullet);
                var h = this.bulletBorderThickness, l = this.bulletBorderColor,
                    m = this.bulletBorderAlpha, n = this.bulletAlpha, s = a.alpha;
                isNaN(s) || (n = s);
                switch (f) {
                    case "round":
            ...
            if (j) {
                ...
                if ("serial" == this.chartType &&
                    (0 > b - f || b - f > this.width || d < -g / 2 || d - h > this.height))j.remove(), j = null;
        ...
        handleRollOver: function (a) {
            if (a) {
                ...
                d && (d = b.formatString(this.balloonText, a, a.graph), d = AmCharts.cleanFromEmpty(d), a = b.getBalloonColor(this, a), b.balloon.showBullet = !1, b.balloon.pointerOrientation =
                    "V", b.showBalloon(d, a, !0))
            }
    ...
    AmCharts.ChartCursor = AmCharts.Class({
        construct: function () {
            ...
            var a = this.chart, b = this.cursorAlpha, d = a.categoryAxis,
                e = d.position, f = d.inside, g = d.axisThickness, h = this.categoryBalloon, j, k, l = a.dx, m = a.dy, n = this.x, s = this.y, p = this.width, q = this.height, a = a.rotate, r = d.tickLength;
            h.pointerWidth = r;
            a ? (j = [0, p, p + l], k = [0, 0, m]) : (j = [l, 0, 0], k = [m, 0, q]);
            this.line = b = AmCharts.line(this.container, j, k, this.cursorColor, b, 1);
            this.set.push(b);
            a ? (f && (h.pointerWidth = 0), "right" == e ? f ? h.setBounds(n, s + m, n + p + l, s + q + m) : h.setBounds(n + p + l + g, s + m, n + p + 1E3, s + q + m) : f ? h.setBounds(n, s, p + n, q + s) : h.setBounds(-1E3, -1E3, n - r - g, s + q + 15)) : (h.maxWidth = p, d.parseDates &&
            (r = 0, h.pointerWidth = 0), "top" == e ? f ? h.setBounds(n + l, s + m, p + l + n, q + s) : h.setBounds(n + l, -1E3, p + l + n, s + m - r - g) : f ? h.setBounds(n, s, p + n, q + s - r) : h.setBounds(n, s + q + r + g - 1, n + p, s + q + r + g));
            this.hideCursor()
            ...
            var d = this.selectionPosX, e = this.selectionPosY, f = 0, g = 0, h = this.width, j = this.height;
            ...
            if (this.enabled) {
                void 0 === b && (b = !0);
                this.index = a;
                var g = d.categoryAxis, h = d.dx, j = d.dy, k = this.x, l = this.y, m = this.width, n = this.height, s = this.data[a], p = s.x[g.id], q = d.rotate, r = g.inside, u = this.stepWidth, t = this.categoryBalloon,
                    v = this.firstTime, x = this.lastTime, y = this.cursorPosition, w = g.position, z = this.zooming, C = this.panning, I = d.graphs, G = g.axisThickness;
                if (d.mouseIsOver || z || C || this.forceShow)if (this.forceShow = !1, C) {
                    ...
                    0 !== e && (h = {
                        type: "zoomed",
                        target: this
                    }, h.chart = this.chart, g.parseDates && !g.equalSpacing ? (d + e > x && (e = x - d), z + e < v && (e = v - z), h.start = z + e, h.end = d + e,
                        this.fire(h.type, h)) : k + e >= this.data.length || 0 > l + e || (h.start = l + e, h.end = k + e, this.fire(h.type, h)))
                } else {
                    "start" == y && (p -= g.cellWidth / 2);
                    "mouse" == y && d.mouseIsOver && (p = q ? f - 2 : e - 2);
                    if (q) {
                        if (0 > p)if (z)p = 0; else {
                            this.hideCursor();
                            return
                        }
                        if (p > n + 1)if (z)p = n + 1; else {
                            this.hideCursor();
                            return
                        }
                    } else {
                        ...
                        if (p > m)if (z)p = m; else {
                            this.hideCursor();
                            return
                        }
                    }
                    0 < this.cursorAlpha && (v = this.line, q ? v.translate(0, p + j) : v.translate(p, 0), v.show());
                    this.linePos = q ? p + j : p;
                    z && (q ? this.updateSelectionSize(NaN,
                        p) : this.updateSelectionSize(p, NaN));
                    v = !0;
                    z && (v = !1);
                    this.categoryBalloonEnabled && v ? (q ? (r && ("right" == w ? t.setBounds(k, l + j, k + m + h, l + p + j) : t.setBounds(k, l + j, k + m + h, l + p)), "right" == w ? r ? t.setPosition(k + m + h, l + p + j) : t.setPosition(k + m + h + G, l + p + j) : r ? t.setPosition(k, l + p) : t.setPosition(k - G, l + p)) : "top" == w ? r ? t.setPosition(k + p + h, l + j) : t.setPosition(k + p + h, l + j - G + 1) : r ? t.setPosition(k + p, l + n) : t.setPosition(k + p, l + n + G - 1), g.parseDates ? (g = AmCharts.formatDate(s.category, this.categoryBalloonDateFormat), -1 != g.indexOf("fff") && (g = AmCharts.formatMilliseconds(g,
                    ...
                    if (I && this.valueBalloonsEnabled && v && d.balloon.enabled) {
                        ...
                        if (this.oneBalloonOnly) {
                            j = Infinity;
                            for (g = 0; g < I.length; g++)u = I[g], u.showBalloon && (!u.hidden && u.balloonText) && (t = s.axes[u.valueAxis.id].graphs[u.id], x = t.y, isNaN(x) || (q ? Math.abs(e - x) < j && (j = Math.abs(e - x), T = u) : Math.abs(f - x) < j && (j = Math.abs(f - x), T = u)))
                        }
                        for (g = 0; g < I.length; g++)if (u = I[g],
                            !(this.oneBalloonOnly && u != T) && (u.showBalloon && !u.hidden && u.balloonText) && (t = s.axes[u.valueAxis.id].graphs[u.id], x = t.y, !isNaN(x))) {
                            p = t.x;
                            r = !0;
                            if (q) {
                                if (j = x, 0 > p || p > n)r = !1
                            } else if (j = p, p = x, 0 > j || j > m + h)r = !1;
                            r && (r = u.valueBalloon, w = d.getBalloonColor(u, t), r.setBounds(k, l, k + m, l + n), r.pointerOrientation = "H", r.changeColor(w), void 0 !== u.balloonAlpha && (r.fillAlpha = u.balloonAlpha), void 0 !== u.balloonTextColor && (r.color = u.balloonTextColor), r.setPosition(j + k, p + l), u = d.formatString(u.balloonText, t, u), "" !== u && r.showBalloon(u),
                            !q && r.set && r.set.hide(), v.push({yy: x, balloon: r}))
                        }
                        q || this.arrangeBalloons()
                    }
                    b ? (h = {type: "changed"}, h.index = a, h.target = this, h.chart = this.chart, h.zooming = z, h.position = q ? f : e, h.target = this, d.fire("changed", h), this.fire("changed", h), this.skipZoomDispatch = !1) : (this.skipZoomDispatch = !0, d.updateLegendValues(a));
            ...
            if (a) {
                var e = a.mouseX - this.x, f = a.mouseY - this.y;
                if (this.drawingNow) {
                    this.drawingNow = !1;
                ...
                if (this.enabled && 0 < b.length) {
                    if (this.pan)this.rolledOver = !1; else if (this.zoomable && !this.selectWithoutZooming && this.zooming) {
                        d = {type: "zoomed", target: this};
                        d.chart = a;
                        if ("cursor" == this.type)this.rotate ? this.selectionPosY = f : this.selectionPosX = f = e, 2 > Math.abs(f - this.initialMouse) && this.fromIndex == this.index || (this.index < this.fromIndex ? (d.end = this.fromIndex,
                            d.start = this.index) : (d.end = this.index, d.start = this.fromIndex), f = a.categoryAxis, f.parseDates && !f.equalSpacing && (d.start = b[d.start].time, d.end = a.getEndTime(b[d.end].time)), this.skipZoomDispatch || this.fire(d.type, d)); else {
                            var h = this.initialMouseX, j = this.initialMouseY;
                            3 > Math.abs(e - h) && 3 > Math.abs(f - j) || (b = Math.min(h, e), g = Math.min(j, f), e = Math.abs(h - e), f = Math.abs(j - f), a.hideXScrollbar && (b = 0, e = this.width), a.hideYScrollbar && (g = 0, f = this.height), d.selectionHeight = f, d.selectionWidth = e, d.selectionY = g, d.selectionX =
                                b, this.skipZoomDispatch || this.fire(d.type, d))
                        }
                        AmCharts.remove(this.selection)
                    }
    ...
    AmCharts.SimpleChartScrollbar = AmCharts.Class({
        construct: function () {
            ...
            if ((a.height = h) && g) {
                ...
                g = e.pathToImages;
                d ? (j = g + "dragIconH.gif", g = a.dragIconWidth, d = a.dragIconHeight) : (j = g +
                "dragIcon.gif", d = a.dragIconWidth, g = a.dragIconHeight);
                h = b.image(j, 0, 0, d, g);
                var j = b.image(j, 0, 0, d, g), k = 10, l = 20;
            ...
            d = j.x + f;
            e = j.y + g;
            var k = j.width, j = j.height, l = this.rotate, m = this.chart, n = this.width, s = this.height, p = m.mouseX, q = m.mouseY;
            a = this.initialMouse;
            m.mouseIsOver && (this.dragging && (m = this.initialCoord, l ? (a = m + (q - a), 0 > a && (a = 0), m = s - j, a > m && (a = m), h.setAttr("y", a)) : (a = m + (p - a), 0 > a && (a = 0), m = n - k, a > m && (a = m), h.setAttr("x", a))), this.resizingRight &&
            ...
            if (this.skipEvent)this.skipEvent = !1; else {
                ...
                a = {type: "zoomed", position: d, chart: a, target: this, multiplier: f};
                this.fire(a.type, a)
            }
        }, updateDragIconPositions: function () {
            var a = this.getDBox(), b = a.x, d = a.y, e = this.iconLeft,
                f = this.iconRight, g, h, j = this.scrollbarHeight;
            ...
            if (!this.resizingRight && !this.resizingLeft) {
                ...
                b = this.chart;
                var h = this.y, j = this.x, k = this.rotate;
                ...
                this.updateOnReleaseOnly ? (this.skipEvent = !1, e.setAttr(a, b), this.dispatchScrollbarEvent(), this.clipDragger()) : (b = Math.round(b), k ? e.animate({y: b}, d, ">") : e.animate({x: b}, d, ">"))
            }
    ...
    AmCharts.ChartScrollbar = AmCharts.Class({
        inherits: AmCharts.SimpleChartScrollbar, construct: function () {
            ...
            var b = a.chart, d = b.chartData, e = a.categoryAxis, f = a.rotate, g = a.x, h = a.y, j = a.width, k = a.height, l = b.categoryAxis, m = a.set;
            e.setOrientation(!f);
            ...
            if (l = a.graph) {
                ...
                for (p = 0; p < d.length; p++) {
                    ...
                    for (r in q)if (q.hasOwnProperty(r) && "percents" != r && "total" != r) {
                        var u = q[r];
                        u < g && (g = u);
                        u > h && (h = u)
                    }
            ...
            if (this.skipEvent)this.skipEvent = !1; else {
                ...
                b = e.x;
                d = e.y;
                var f = e.width, g = e.height, e = this.chart;
                this.rotate ? (b = d, d = g) : d = f;
                f = {type: "zoomed", target: this};
                f.chart = e;
                var g = this.categoryAxis, h = this.stepWidth;
                if (g.parseDates && !g.equalSpacing) {
                    if (a =
                            e.firstTime, g.minDuration(), e = Math.round(b / h) + a, a = this.dragging ? e + this.timeDifference : Math.round((b + d) / h) + a, e > a && (e = a), e != this.startTime || a != this.endTime)this.startTime = e, this.endTime = a, f.start = e, f.end = a, f.startDate = new Date(e), f.endDate = new Date(a), this.fire(f.type, f)
                } else if (g.startOnAxis || (b += h / 2), d -= this.stepWidth / 2, e = g.xToIndex(b), b = g.xToIndex(b + d), e != this.start || this.end != b)g.startOnAxis && (this.resizingRight && e == b && b++, this.resizingLeft && e == b && (0 < e ? e-- : b = 1)), this.start = e, this.end = this.dragging ?
                this.start + this.difference : b, f.start = this.start, f.end = this.end, g.parseDates && (a[this.start] && (f.startDate = new Date(a[this.start].time)), a[this.end] && (f.endDate = new Date(a[this.end].time))), this.fire(f.type, f)
            }
        }, zoomScrollbar: function () {
            var a, b;
            a = this.chart;
            var d = a.chartData, e = this.categoryAxis;
    ...
    AmCharts.text = function (a, b, d, e, f, g, h, j) {
        g || (g = "middle");
        "right" == g && (g = "end");
        d = {fill: d, "font-family": e, "font-size": f, opacity: j};
    ...
    AmCharts.polygon = function (a, b, d, e, f, g, h, j, k) {
        ...
        void 0 === h && (h = l);
        f = {fill: l, stroke: h, "fill-opacity": f, "stroke-width": g, "stroke-opacity": j};
        g = AmCharts.dx;
        h = AmCharts.dy;
        j = Math.round;
    ...
    AmCharts.rect = function (a, b, d, e, f, g, h, j, k, l) {
        ...
        s += AmCharts.dx;
        p += AmCharts.dy;
        f = {fill: m, stroke: h, "fill-opacity": f, "stroke-opacity": j};
    ...
    AmCharts.triangle = function (a, b, d, e, f, g, h, j) {
        ...
        void 0 === h && (h = "#000");
        void 0 === j && (j = 0);
        e = {fill: e, stroke: h, "fill-opacity": f, "stroke-width": g, "stroke-opacity": j};
        b /= 2;
        var k;
    ...
    AmCharts.wedge = function (a, b, d, e, f, g, h, j, k, l, m) {
        ...
        h = n(h);
        j = n(j);
        var s = n(h / g * j), p = AmCharts.VML, q = -359.5 - g / 100;
        -359.95 > q && (q = -359.95);
        f <= q && (f = q);
        var r = 1 / 180 * Math.PI, q = b + Math.cos(e * r) * j, u = d + Math.sin(-e * r) * s, t = b + Math.cos(e * r) * g, v = d + Math.sin(-e * r) * h, x = b + Math.cos((e + f) * r) * g, y = d + Math.sin((-e - f) * r) * h, w = b + Math.cos((e + f) * r) * j, r = d + Math.sin((-e - f) * r) * s, z = {
        ...
        e = a.set();
        var I;
        p && (q = n(10 * q), t = n(10 * t), x =
            n(10 * x), w = n(10 * w), u = n(10 * u), v = n(10 * v), y = n(10 * y), r = n(10 * r), b = n(10 * b), k = n(10 * k), d = n(10 * d), g *= 10, h *= 10, j *= 10, s *= 10, 1 > Math.abs(f) && (1 >= Math.abs(x - t) && 1 >= Math.abs(y - v)) && (I = !0));
        f = "";
        if (0 < k) {
            p ? (path = " M" + q + "," + (u + k) + " L" + t + "," + (v + k), I || (path += " A" + (b - g) + "," + (k + d - h) + "," + (b + g) + "," + (k + d + h) + "," + t + "," + (v + k) + "," + x + "," + (y + k)), path += " L" + w + "," + (r + k), 0 < j && (I || (path += " B" + (b - j) + "," + (k + d - s) + "," + (b + j) + "," + (k + d + s) + "," + w + "," + (k + r) + "," + q + "," + (k + u)))) : (path = " M" + q + "," + (u + k) + " L" + t + "," + (v + k), path += " A" + g + "," + h + ",0," + C +
            ",1," + x + "," + (y + k) + " L" + w + "," + (r + k), 0 < j && (path += " A" + j + "," + s + ",0," + C + ",0," + q + "," + (u + k)));
            path += " Z";
        ...
        p ? (I || (f = " A" + n(b - g) + "," + n(d - h) + "," + n(b + g) + "," + n(d + h) + "," + n(t) + "," + n(v) + "," +
        n(x) + "," + n(y)), g = " M" + n(q) + "," + n(u) + " L" + n(t) + "," + n(v) + f + " L" + n(w) + "," + n(r)) : g = " M" + q + "," + u + " L" + t + "," + v + (" A" + g + "," + h + ",0," + C + ",1," + x + "," + y) + " L" + w + "," + r;
    ...
    AmCharts.AmPieChart = AmCharts.Class({
        inherits: AmCharts.AmChart, construct: function (options) {
            ...
            if (AmCharts.ifArray(b)) {
                if (0 < a.realWidth && 0 < a.realHeight) {
                    ...
                    a.realHeight = g;
                    var h = AmCharts.toCoordinate, j = h(a.marginLeft, f), k = h(a.marginRight, f), l = h(a.marginTop, g) + a.getTitleHeight(), m = h(a.marginBottom, g);
                    a.chartDataLabels = [];
                    a.ticks = [];
                    ...
                    p || (f = 0 <= q ? f - j - k - 2 * r : f - j - k, g = g - l - m, p = Math.min(f, g), g < f && (p /= 1 - a.angle / 90, p > f && (p = f)), a.pullOutRadiusReal = AmCharts.toCoordinate(a.pullOutRadius, p), p = 0 <= q ? p - 1.8 * (q + a.pullOutRadiusReal) : p - 1.8 * a.pullOutRadiusReal, p /= 2);
                    ...
                    for (m = 0; m < b.length; m++)if (f = b[m], !0 !== f.hidden && 0 < f.percents) {
                        var u = 360 * -f.percents / 100, r = Math.cos((g + u / 2) / 180 * Math.PI), k = Math.sin((-g - u / 2) / 180 * Math.PI) * (l / p), j = {
                            fill: f.color,
                        ...
                        if (a.labelsEnabled && a.labelText && f.percents >= a.hideLabelsPercent) {
                            ...
                            if (0 <= q) {
                                var x;
                                90 >= u && 0 <= u ? (x = 0, v = "start", t = 8) : 360 >= u && 270 < u ? (x = 1, v = "start", t = 8) : 270 >= u && 180 < u ? (x = 2, v = "end", t = -8) : 180 >= u && 90 < u && (x = 3, v = "end", t = -8);
                                f.labelQuarter = x
                            } else v = "middle";
                            u = a.formatString(a.labelText, f);
                            u = AmCharts.text(e, u, a.color, a.fontFamily,
                                a.fontSize, v);
            ...
            for (e = b - 1; 0 <= e; e--)d = a[e], 0 === d.labelQuarter && !d.hidden && this.checkOverlapping(e, d, 0, !0, 0);
            ...
            if (l) {
                if (!0 === e)for (h = a + 1; h < k; h++)(g = this.checkOverlappingReal(b, j[h], d)) && (h = k); else for (h = a - 1; 0 <= h; h--)(g = this.checkOverlappingReal(b, j[h], d)) && (h = 0);
            ...
            var e = a.ix * d + this.pieXReal, d = a.iy * d + this.pieYReal, f = this.formatString(this.balloonText, a), g = AmCharts.adjustLuminosity(a.color, -0.15);
            ...
            1 == b ? (a.pulled = !0, this.pullOutOnlyOne && this.pullInAll(a.index),
                a = {type: "pullOutSlice", dataItem: a, chart: this}) : (a.pulled = !1, a = {
                type: "pullInSlice",
                dataItem: a,
                chart: this
            });
        ...
        recalculatePercents: function () {
            ...
            for (d = 0; d < a.length; d++)e = a[d], !e.hidden && 0 < e.value && (b += e.value);
    ...
    AmCharts.AmXYChart = AmCharts.Class({
        inherits: AmCharts.AmRectangularChart, construct: function () {
            ...
            var a = this.marginLeftReal,
                b = this.marginTopReal, d = this.plotAreaWidth, e = this.plotAreaHeight;
            ...
            0 === b.length && (e = new AmCharts.ValueAxis, e.rotate = !1, e.setOrientation(!1), d.push(e),
                b.push(e));
        ...
        toggleZoomOutButton: function () {
            ...
            if (a = this.chartCursor)a.updateData(),
                a.type = "crosshair", a.valueBalloonsEnabled = !1
        }, zoomOut: function () {
            ...
            var b = this.widthMultiplier * this.plotAreaWidth /
                a.selectionWidth, d = this.heightMultiplier * this.plotAreaHeight / a.selectionHeight, b = this.fitMultiplier(b), d = this.fitMultiplier(d);
            ...
            if ("H" == a.valueAxis.orientation) {
                var b = this.fitMultiplier(a.multiplier);
                a = -a.position / this.widthMultiplier *
                b;
                var d = -(this.plotAreaWidth * b - this.plotAreaWidth);
                a < d && (a = d);
                this.horizontalPosition = a;
    ...
    AmCharts.AmDraw = AmCharts.Class({
        construct: function (a, b, d) {
            ...
            1 > d && (d = 1);
            1 > e && (e = 1);
            j.attr({x: a, y: b, width: d, height: e, rx: f, ry: f, "stroke-width": g});
    ...
    AmCharts.VMLRenderer = AmCharts.Class({
        construct: function (a) {
            ...
            if (void 0 !== d) {
                ...
                if (h =
                        a.children)for (j = 0; j < h.length; j++)h[j].setAttr(b, d);
                if ("shape" == g) {
                    ...
                    "stroke-dasharray" == b && (h = "solid", 0 < d && 3 > d && (h = "dot"), 3 <= d && 6 >=
                    d && (h = "dash"), 6 < d && (h = "longdash"), e ? g.dashstyle = h : g.setAttribute("dashstyle", h));
            ...
            a = a.bw;
            isNaN(a) || (b -= a, d -= a);
            !isNaN(b) && !isNaN(d) && (e.style.left = b + "px", e.style.top = d + "px")
            ...
            for (f = 0; f < b.length; f++) {
                var g = b[f], h = g.substring(0, 1), g = g.substring(1), j = g.split(","), k = e(j[0]) + "," + e(j[1]);
                "M" == h && (a += " m " + k);
                "L" == h && (a += " l " + k);
                "Z" == h && (a += " x e");
                if ("Q" == h) {
                    var l = d.length, m = d[l - 1], n = j[0], s = j[1], k = j[2], p = j[3];
                    d = e(d[l - 2] / 3 + 2 / 3 * n);
                    m = e(m / 3 + 2 / 3 * s);
                    n = e(2 / 3 * n + k / 3);
                    s = e(2 / 3 * s + p / 3);
            ...
            if ("translate" == b) {
                ...
                b = j[1];
                d = h.offsetTop;
                h = {obj: a, frame: 0, attribute: "left", from: h.offsetLeft, to: j[0], time: e, effect: f};
                g.animations.push(h);
            ...
            for (a = this.animations.length - 1; 0 <= a; a--) {
                ...
                if (e <= d) {
                    b.frame++;
                    var h = Number(b.from), j = Number(b.to) - h, b = this.D[b.effect](0, e, h, j, d);
            ...
            e.backgroundColor = f;
            e.paddingLeft = 1;
            var f = b * Math.PI / 180, g = Math.cos(f), h = Math.sin(f), j = AmCharts.removePx(e.left), k = AmCharts.removePx(e.top),
                l = d.offsetWidth, d = d.offsetHeight, m = b / Math.abs(b);
    ...
    AmCharts.SVGRenderer = AmCharts.Class({
        construct: function (a) {
            ...
            var g = this, h = a.node;
            "translate" == b ? (h = (h = h.getAttribute("transform")) ? String(h).substring(10, h.length - 1) : "0,0", h = h.split(", ").join(" "), h = h.split(" ").join(","), 0 === h && (h =
                "0,0")) : h = h.getAttribute(b);
            ...
            for (a = this.animations.length - 1; 0 <= a; a--) {
                ...
                e <= d ? (b.frame++, "translate" == g ? (h = b.from.split(","), g = Number(h[0]), h = Number(h[1]), j = b.to.split(","), k = Number(j[0]),
